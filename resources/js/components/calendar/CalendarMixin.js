/*
  Modified from the vue-simple-calendar library: https://github.com/richardtallent/vue-simple-calendar/
  https://github.com/richardtallent/vue-simple-calendar/blob/master/src/components/CalendarMathMixin.js
*/
/*
***********************************************************
...
export default {
    ...
    changeMonth(date, count){
      return this.incrementPeriod(date, "month", count);
    },
